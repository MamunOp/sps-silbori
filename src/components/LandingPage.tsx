    ...
    <div className="bg-[#F8FAFC] text-slate-900 overflow-x-hidden font-sans">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-32 pb-24">
          <div className="max-w-4xl text-center md:text-left mx-auto md:mx-0">
            ...
            <motion.h1
              ...
              className="text-4xl md:text-[72px] font-display font-extrabold leading-[0.95] tracking-tighter text-white mb-8 text-center md:text-left"
            >
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mb-12 text-center md:text-left mx-auto md:mx-0"
            >
            ...
            <motion.div
              ...
              className="grid grid-cols-2 lg:grid-cols-4 gap-8 mt-20 pt-10 border-t border-white/10 max-w-3xl mx-auto md:mx-0"
            >
              {stats.map((stat, i) => (
      ...
      <section className="relative z-20 -mt-16 sm:-mt-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-slate-100 grid md:grid-cols-2 lg:grid-cols-4 gap-10 items-center">
            <div className="flex items-center gap-5 justify-center md:justify-start border-b md:border-b-0 pb-10 md:pb-0 border-slate-100">
            ...
            <div className="flex items-center gap-5 justify-center md:justify-start border-b lg:border-b-0 pb-10 md:pb-0 border-slate-100">
      ...
      <section id="about" className="py-24 md:py-32 overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <span className="text-blue-600 font-extrabold uppercase tracking-[0.2em] text-sm mb-6 block">Welcome to Skyline</span>
            <h2 className="text-3xl md:text-5xl font-display font-extrabold leading-[1.1] tracking-tight text-slate-950 mb-8 mx-auto md:mx-0 max-w-xl">
              True Education <br className="hidden md:block" />
              Beyond Classrooms.
            </h2>
            <p className="text-lg text-slate-600 leading-relaxed mb-10 max-w-xl mx-auto md:mx-0">
            ...
            <div className="grid sm:grid-cols-2 gap-8 mb-12 text-center md:text-left">
              {[
                ...
                <div key={i} className="flex flex-col md:flex-row items-center md:items-start gap-4 mx-auto md:mx-0">
                  <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center shrink-0">
                    <CheckCircle2 className="w-6 h-6 text-blue-600" />
                  </div>
                  <div>
                    <h5 className="font-bold text-slate-900">{feature.title}</h5>
                    <p className="text-sm text-slate-500 mt-1 max-w-[200px]">{feature.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-20 gap-8">
            <div className="text-center md:text-left mx-auto md:mx-0">
              ...
              <h2 className="text-3xl md:text-5xl font-display font-extrabold leading-[1.1] tracking-tight text-center md:text-left mx-auto md:mx-0">
                A World-Class Modern Campus.
              </h2>
            </div>
            <button className="h-14 px-8 rounded-2xl border border-white/20 font-bold hover:bg-white/10 transition-colors w-full md:w-auto">
              View All Facilities
            </button>
          </div>
      ...
      <section id="contact" className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-5 gap-20">
          <div className="lg:col-span-2 space-y-12 text-center md:text-left mx-auto md:mx-0">
            <div>
              <span className="text-blue-600 font-extrabold uppercase tracking-[0.2em] text-sm mb-6 block">Ready to Connect?</span>
              <h2 className="text-3xl md:text-5xl font-display font-extrabold leading-[1.1] tracking-tight text-slate-950 mb-8 mx-auto md:mx-0">
      ...
      <footer className="bg-slate-950 text-white py-24 pb-12 overflow-hidden border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-4 gap-16 mb-24">
            <div className="lg:col-span-2 space-y-10 group text-center md:text-left mx-auto md:mx-0">
            ...
            <div className="text-center md:text-left">
              ...
              <ul className="space-y-4 text-slate-400">
                <li className="flex items-center gap-3 justify-center md:justify-start"><Phone size={16} className="text-blue-500" /> +91 98765 43210</li>
                <li className="flex items-center gap-3 justify-center md:justify-start"><Mail size={16} className="text-blue-500" /> info@skyline.edu.in</li>
                <li className="flex items-center gap-3 justify-center md:justify-start leading-relaxed"><MapPin size={16} className="text-blue-500" /> Mangaldoi, Darrang, <br />Assam 784125</li>
              </ul>
            </div>
          </div>
