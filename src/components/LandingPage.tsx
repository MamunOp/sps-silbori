  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 font-sans selection:bg-blue-600 selection:text-white overflow-x-hidden">
      ...
      <nav className={`fixed w-full z-50 transition-all duration-500 no-print ${
        isScrolled ? 'top-0 bg-white shadow-sm py-4' : 'top-0 md:top-10 bg-transparent py-6'
      }`}>
      ...
      {/* 3. HERO SECTION */}
      <header className="relative min-h-screen md:min-h-[90vh] flex items-center px-6 pt-32 pb-20 md:pt-0 md:pb-0 overflow-hidden bg-gradient-to-br from-blue-50/50 to-white">
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
          ...
          >
            <div className="space-y-4 md:space-y-6">
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black leading-[1.1] tracking-tight text-blue-900 uppercase">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {trustCards.map((card, i) => (
              <motion.div 
                key={i}
                whileHover={{ y: -8 }}
                className="p-8 rounded-[2.5rem] bg-slate-50 border border-slate-100 group transition-all"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
                <div className="grid grid-cols-2 gap-6 scale-90 md:scale-100">
                    <div className="aspect-[3/4] bg-slate-200 rounded-[3rem] overflow-hidden mt-20 shadow-2xl relative">
                    ...
                    <div className="aspect-[3/4] bg-slate-200 rounded-[3rem] overflow-hidden shadow-2xl relative border-8 border-white">
            ...
            <div className="space-y-10">
                <div className="space-y-4">
                  ...
                  <h2 className="text-4xl md:text-6xl font-black text-blue-900 uppercase leading-[0.9] tracking-tighter">
      ...
      {/* 6. CLASS SECTION */}
      <section id="academics" className="py-24 bg-slate-900 text-white rounded-[4rem] mx-4 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end gap-10 mb-20 relative z-10">
            <div className="space-y-4">
              <span className="text-amber-500 text-[10px] font-black uppercase tracking-[0.5em]">Academic Structure</span>
              <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none italic">Academic <br /> <span className="text-blue-400">Pathways</span></h2>
            </div>
            <p className="text-slate-400 max-w-sm text-lg font-medium leading-relaxed">Systematic learning tiers designed for progressive cognitive development.</p>
          </div>
      ...
      <section id="facilities" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-20">
          <div className="max-w-3xl mx-auto space-y-6">
            <h2 className="text-4xl md:text-6xl font-black text-blue-900 uppercase tracking-tighter leading-none italic">Premium <br /> Campus Facilities</h2>
            <p className="text-slate-500 font-medium text-lg leading-relaxed">Providing a world-class infrastructure and specialized environments for modern, activity-based education.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {facilities.map((fac, i) => (
              <motion.div 
                ...
                className="relative h-72 rounded-[3rem] overflow-hidden group shadow-lg"
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-blue-900/90 via-blue-950/20 to-transparent flex flex-col justify-end p-8 text-left transition-all group-hover:from-blue-600/90">
                  ...
                  <h4 className="text-xl font-black text-white uppercase tracking-tight leading-none">{fac.name}</h4>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-24 bg-blue-900 text-white rounded-[4rem] mx-4 mb-24 relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 lg:grid-cols-4 gap-12 text-center relative z-10">
            {[
              { val: "1000+", label: "Happy Students", sub: "Growing Every Year" },
              { val: "95%", label: "Parent Satisfaction", sub: "Registry Reviews" },
              { val: "15+", label: "Activities", sub: "Sports & Creative" },
              { val: "18+", label: "Qualified Faculty", sub: "Expert Mentors" }
            ].map((stat, i) => (
              <div key={i} className="space-y-3">
                <h3 className="text-5xl font-black tracking-tighter italic text-amber-500">{stat.val}</h3>
                <div className="h-0.5 w-12 bg-white/20 mx-auto" />
                <p className="text-xl font-black uppercase tracking-tight">{stat.label}</p>
                <p className="text-xs font-medium text-blue-200/50 uppercase tracking-widest">{stat.sub}</p>
              </div>
            ))}
         </div>
         {/* Decorative Circles */}
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-16">
          <div className="flex flex-col md:flex-row justify-between items-end gap-10">
             <div className="space-y-4">
                ...
                <h2 className="text-4xl md:text-6xl font-black text-blue-900 uppercase leading-none tracking-tighter italic">Gallery <br /> <span className="text-slate-300">Curations</span></h2>
             </div>
             <div className="flex gap-4 overflow-x-auto pb-4 md:pb-0">
                {['Classroom', 'Sports', 'Events', 'Celebrations'].map((cat) => (
                  <Button key={cat} variant="ghost" className="h-10 px-6 rounded-full font-black text-[10px] uppercase tracking-widest text-slate-400 hover:text-blue-900 hover:bg-blue-50">
                    {cat}
                  </Button>
                ))}
             </div>
      ...
      <section id="admissions" className="py-24 bg-slate-50 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-20">
          <div className="space-y-6">
            <h2 className="text-4xl md:text-6xl font-black text-blue-900 uppercase tracking-tighter italic">Simple Admission Process</h2>
            <p className="text-slate-500 font-medium text-lg max-w-2xl mx-auto">Follow these four simple steps to secure your child's seat in the academic session 2026-27.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative">
             ...
             {[
               ...
               <div key={i} className="relative z-10 space-y-6">
                 <div className="w-24 h-24 bg-white rounded-[2rem] border border-slate-100 shadow-sm flex items-center justify-center mx-auto text-3xl font-black text-blue-900 group hover:bg-blue-900 hover:text-white transition-all">
                   {step.id}
                 </div>
                 <div className="space-y-2">
                    <h3 className="text-xl font-black text-blue-900 uppercase tracking-tight">{step.title}</h3>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center space-y-4 mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-blue-900 uppercase tracking-tighter italic">Trusted by <span className="text-slate-300">Families</span></h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={i} className="p-10 rounded-[3rem] border-slate-50 bg-slate-50/50 space-y-8 hover:bg-white hover:shadow-2xl hover:shadow-slate-200/50 transition-all cursor-default">
      ...
      {/* 12. NOTICE / EVENTS */}
      <section className="py-24 bg-slate-100 mb-20 rounded-[3rem] mx-4 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 relative z-10">
          <div className="space-y-10">
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl font-black text-blue-900 uppercase italic">Bulletin <span className="text-amber-500">&</span> Events</h2>
              <p className="text-slate-500 font-medium">Stay updated with the latest circulars and upcoming school activities.</p>
            </div>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="bg-white p-6 rounded-3xl border border-slate-200 flex items-center gap-6 group hover:border-blue-900 transition-colors">
                  <div className="w-16 h-16 bg-blue-50 rounded-2xl flex flex-col items-center justify-center shrink-0">
                    <span className="text-xl font-black text-blue-900 leading-none">{n.date.split(' ')[0]}</span>
                    <span className="text-[8px] font-black uppercase text-blue-400">{n.date.split(' ')[1]}</span>
                  </div>
                  <div>
                    <h4 className="font-black text-blue-900 uppercase tracking-tight">{n.title}</h4>
                    <span className="text-[9px] font-bold uppercase tracking-widest text-slate-400">{n.type}</span>
                  </div>
                  <Button variant="ghost" size="icon" className="ml-auto text-slate-300 group-hover:text-blue-900">
      ...
      <section id="contact" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-stretch">
          <div className="space-y-12">
            <div className="space-y-6">
              <h2 className="text-4xl md:text-6xl font-black text-blue-900 uppercase leading-none tracking-tighter italic">Connect With <br /> <span className="text-amber-500">Registry.</span></h2>
              <p className="text-slate-500 font-medium text-lg leading-relaxed max-w-sm">Have queries or want to schedule a visit? Our helpdesk is 24x7 ready to assist you.</p>
            </div>
          ...
          <Card className="bg-slate-50 border border-slate-100 p-8 md:p-12 rounded-[3.5rem] shadow-sm flex flex-col space-y-8">
             <div className="space-y-2">
               <h3 className="text-2xl font-black text-blue-900 uppercase tracking-tighter">Inquiry Ledger</h3>
               <p className="text-sm font-medium text-slate-400 uppercase tracking-widest">We respond within 24 operational hours.</p>
             </div>
      ...
      <footer className="bg-slate-900 text-white pt-24 pb-32 md:pb-12 px-6 overflow-hidden relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 relative z-10">
          <div className="col-span-1 md:col-span-2 lg:col-span-1 space-y-8">
            ...
            <p className="text-slate-400 font-medium leading-relaxed">Dedicated to building brighter futures through innovative learning and holistic character development since 2009.</p>
